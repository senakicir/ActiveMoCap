...
class external_dataset_client(object):
    def __init__(self, length_of_simulation, test_set_name, non_simulation_files):
        ...
        self.openpose_res_matrix = None#get_pose_matrix(self.files["f_pose_2d"], self.num_of_data, self.num_of_samples, dim=2)
        self.liftnet_res = None#read_pose_from_file(self.files["f_pose_lift"], dim=3, num_of_joints=15)
