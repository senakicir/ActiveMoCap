...
class DroneFlightClient(External_Dataset_Client):
    ...
    def read_pose_from_file(self, input_file, dim, num_of_joints):
    ...
    def read_gt_pose(self, input_file, test_set_name):
    ...
    def get_pose_matrix(self,input_file, num_of_data, num_of_samples, dim):
