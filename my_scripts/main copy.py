...
if __name__ == "__main__":
    ...
    #loop_mode = 0-normal_simulation, teleport_simulation, 1-openpose, 2-toy_example, 3-create_dataset, 4- save_gt_poses 5-calibration
    ...
    calibration_window_size = 20 #length_of_simulation-20
    ...
    if projection_method == "normal" or projection_method == "normalized":
        weights =  {'proj': 0.001, 'smooth': 1, 'bone': 1, 'lift': 0.05}
