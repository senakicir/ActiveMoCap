...
ffmpeg -framerate 5 -start_number $calib_len -i  'lift_res_%01d.png' -c:v libx264 -pix_fmt yuv420p -vf pad="width=iw+1:height=ih:x=0:y=0:color=white" lift_res.mp4
ffmpeg -framerate 5 -start_number $calib_len -i  'lift_res_2_%01d.png' -c:v libx264 -pix_fmt yuv420p -vf pad="width=iw+1:height=ih:x=0:y=0:color=white" lift_res_2.mp4
...
ffmpeg -framerate 5 -i 'plot3d_%01d.png' -vframes $calib_len -c:v libx264 -pix_fmt yuv420p -vf pad="width=iw+1:height=ih:x=0:y=0:color=white" plot3d_calib.mp4
ffmpeg -framerate 5 -start_number $calib_len -i  'plot3d_%01d.png' -c:v libx264 -pix_fmt yuv420p -vf pad="width=iw+1:height=ih:x=0:y=0:color=white" plot3d_flight.mp4
...
ffmpeg -framerate 2 -i 'covariance%01d.png' -vframes $calib_len -c:v libx264 -pix_fmt yuv420p -vf pad="width=iw:height=ih+1:x=0:y=0:color=white" covariance_calib.mp4
ffmpeg -framerate 2 -start_number $calib_len -i 'covariance%01d.png' -c:v libx264 -pix_fmt yuv420p -vf pad="width=iw:height=ih+1:x=0:y=0:color=white" covariance_flight.mp4
...
ffmpeg -framerate 2 -start_number $calib_len -i 'future_plot_%01d.png' -c:v libx264 -pix_fmt yuv420p -vf pad="width=iw+1:height=ih:x=0:y=0:color=white" future_plot.mp4
ffmpeg -framerate 2 -start_number $calib_len -i 'future_current_cov_%01d.png' -c:v libx264 -pix_fmt yuv420p -vf pad="width=iw+1:height=ih+1:x=0:y=0:color=white" future_current_cov.mp4
ffmpeg -framerate 2 -start_number $calib_len -i 'potential_covs_%01d.png' -c:v libx264 -pix_fmt yuv420p -vf pad="width=iw+1:height=ih+1:x=0:y=0:color=white" potential_covs.mp4
ffmpeg -framerate 2 -start_number $calib_len -i 'potential_states_%01d.png' -c:v libx264 -pix_fmt yuv420p -vf pad="width=iw+1:height=ih:x=0:y=0:color=white" potential_states.mp4
ffmpeg -framerate 2 -start_number $calib_len -i 'potential_ellipses_%01d.png' -c:v libx264 -pix_fmt yuv420p -vf pad="width=iw+1:height=ih:x=0:y=0:color=white" potential_ellipses.mp4

cd ../images

[ -e img.mp4] && rm img.mp4
ffmpeg -framerate 2 'img_%01d.png' -c:v libx264 -pix_fmt yuv420p -vf pad="width=iw:height=ih:x=0:y=0:color=white" img.mp4
