...
class State(object):
    def __init__(self, active_parameters, model_settings, anim_gt_array, future_window_size,  initial_drone_pos, camera_offset_x):
        ...
        self.radius = active_parameters["SAFE_RADIUS"]
    ...
    def deepcopy_state(self):
        new_state = State(self.active_parameters, self.model_settings, self.anim_gt_array, self.future_window_size, self.initial_drone_pos, self.camera_offset_x)
